...
class ClassicGameTest {
    ...
    fun testMovePiece() {
        ...
        val game = ClassicGame(TEST_GAME_NAME, mutableSetOf(pawn, enemyPawn))
    ...
    fun testIsGameOver() {
        ...
        // . . . . . . . .
        // . . . . . . . .
        val finishedGame = ClassicGame(TEST_GAME_NAME, mutableSetOf(bKing, bPawn, wQueen))
        ...
        val unfinishedGame =
            ClassicGame(TEST_GAME_NAME, mutableSetOf(bKing, bPawn, unthreateningWQueen))
    ...
    // . . . . . . . .
    private val game =
        ClassicGame(TEST_GAME_NAME, mutableSetOf(bKing, bBishop, bPawn, wQueen))
    ...
    fun testFilterBlockingMoves() {
        ...
        val game2 =
            ClassicGame(TEST_GAME_NAME, mutableSetOf(bKing, bBishop, wQueen, wRook))
    ...
    fun testGetLegalMovesForPiece() {
        ...
        val game = ClassicGame("", setOf(bKing, bEmpress, wEmpress, wKnight))
